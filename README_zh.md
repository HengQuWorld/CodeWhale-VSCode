...
[![Version](https://img.shields.io/badge/version-0.4.4-blue)](https://github.com/HengQuWorld/CodeWhale-VSCode)
...
### 安装 VSIX
```bash
code --install-extension /path/to/brotherwhale-vscode-0.4.4.vsix --force
```
