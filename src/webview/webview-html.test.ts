...
function makeTr(): WebviewTranslations {
  return {
    ...
    agentStatusWaiting: "{count} waiting",
    agentStatusWaitingOne: "“{title}” is waiting for your approval or input — click to answer it here",
    agentStatusWaitingMany: "{count} threads need you — click to answer the longest-waiting “{title}”",
    ...
    continueSessionTooltip: "Open this saved session as a live conversation",
    forkFromTurnLabel: "Branch",
    forkFromTurnTooltip: "Branch from here",
    forkRunning: "Branching this conversation…",
    hostOperationHint: "This is still being created",
