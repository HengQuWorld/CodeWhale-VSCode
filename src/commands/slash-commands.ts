...
const COMMANDS: SlashCommand[] = [
  ...
  { name: "/verbose", desc: "Toggle verbose mode", category: "unavailable", availability: "unavailable", helpText: "Not available: the GUI has no verbose output mode to toggle. The command previously wrote a setting nothing read." },
  ...
  { name: "/goal", desc: "Set a goal", category: "core", availability: "full", helpText: "/goal [<objective> [| budget: <tokens>] | status | done | blocked | clear] - Set, inspect, or close the current thread's goal" },
  ...
  { name: "/profile", desc: "Switch profile", category: "unavailable", availability: "unavailable", helpText: "Not available: switching profiles must be passed to the engine at startup, which the GUI does not do. Profiles live in ~/.deepseek/config.toml under [profiles]." },
  { name: "/translate", desc: "Toggle translation", category: "unavailable", availability: "unavailable", helpText: "Not available: translation mode is a TUI feature. The command previously wrote a setting nothing read." },
